...
其实 Codex 是按项目来管理工作的。你可以把一个项目理解成一个独立的工作空间，把一次对话理解成这个项目下面的一条线程。
...
| 线程 | 项目下面的一次对话 | 修一个问题、加一个功能、整理一篇文章 |
...
可以，但不建议一直这样做。线程太长以后，历史信息会变多，Codex 更容易被旧任务干扰。
...
- [AGENTS.md 怎么写？让 Codex 按你的规则做事](/tips/agents-md)
